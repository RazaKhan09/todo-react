...
function Todo(props) {
  ...
  return (
    // <div>
    //   <br />
    //   <h1 className='text-3xl'>Todos: {tobecompleted}</h1>
    //   <br />
    ...
    //               const res=await axios.post("http://localhost:8000/completetodo",{_id:todo._id,isCompleted:true},
    //                 {withCredentials:true}
    //               )
    //               console.log(res)
    //               // get todos from backend
    //             const gettodos=await axios.post("http://localhost:8000/gettodos", {},{
    //             withCredentials:true
    //               });
    //             console.log(gettodos)
    //             props.setTodos(gettodos.data)
        
    //             const resc=await axios.post("http://localhost:8000/completedtodos", {
    //                 },{
    //                 withCredentials:true
    //               });
    //                 console.log(resc)
    ...
    //           }} />
    //           <div className='text-white' style={{display:changeid===todo._id?'none':'block'}} >{todo.content}</div>
    //           <input key={todo.id}  value={change} onChange={(e) => setChange(e.target.value)} className='hidden text-white border border-white' style={{display:changeid===todo._id?'block':'none'}} />
    //         </div>
    //         <div className='flex'>
    //           <button style={{display:changeid===todo._id?'none':'block'}} onClick={()=>{
    //             setChangeid(todo._id)
                
    //           }} className="text-white bg-red-500 border-0 py-1 px-4 focus:outline-none hover:bg-red-600 rounded text-md mr-3.5">
    //             <svg
    ...
    //           </button>
    //           <button className='hidden text-white bg-red-500 border-0 py-1 px-4 focus:outline-none hover:bg-red-600 rounded text-md mr-3.5' style={{display:changeid===todo._id?'block':'none'}} onClick={async () => {
                
    //             //updating todo
    //             const res=await axios.post("http://localhost:8000/updatetodo",{_id:todo._id,content:change},
    //                 {withCredentials:true}
    //               )
    //               console.log(res)
    ...
    //           </button>
    //           <button
    //             className="text-white bg-red-500 border-0 py-1 px-4 focus:outline-none hover:bg-red-600 rounded text-md" onClick={async()=>{
    //             // deleting todo
    //             const res=await axios.post("http://localhost:8000/deletetodo",{_id:todo._id},
    //                 {withCredentials:true}
    //               )
    //               console.log(res)
    //                //getting todos from backend
    ...
    //   </ul>
    //   <br />
    //   <div className='text-3xl'>Completed: {completed} </div>
    //   <ul className="list-none">
    ...
    //             //uncompleting todo
    //             const res=await axios.post("http://localhost:8000/completetodo",{_id:elem._id,isCompleted:false},
    //                 {withCredentials:true}
    //               )
    //               console.log(res)
    //               //getting todos from backend
    ...
    //           }} />
    //           <del className='text-white'>{elem.content}</del>
    //         </div>
    //         <button
    //           onClick={async() =>{
    //           //deleting todo
    //           const res=await axios.post("http://localhost:8000/deletetodo",{_id:elem._id},
    //                 {withCredentials:true}
    //               )
    //               console.log(res)
    //               //getting todo from backend
    //             const resc=await axios.post("http://localhost:8000/completedtodos", {
    //               },{
    //                 withCredentials:true
    //               });
    ...
    //   <br />
    //   <div className='text-3xl mb-3.5'>Progress Bar: {progress}%</div>
